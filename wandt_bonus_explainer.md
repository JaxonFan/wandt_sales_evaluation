...
*A guide a manager can read straight to a sales associate. No formulas, no jargon.*
...
## 3. New accounts
Land a brand-new customer and you earn a **share of everything it buys for its first 3 months** — bigger
account, bigger payout. After that it joins your normal book. (If an account just "shows up" assigned to
you rather than won by you, your manager can mark it so it doesn't count as a new-account win.)

## The bottom line
- **Sell** → a little per line.
- **Grow** → beat a fair target that already accounts for the market and your account sizes.
- **Land new** → a share of new business for its first quarter.
